...
export const DescriptionContent = ({ data, onUserScroll }: DescriptionContentProps) => {
  ...
  return (
    <div className="product_detail_desc p-12">
      <div className="relative">
        <div
          className={`product_detail_desc-content h-full overflow-scroll scrollbar-hide ${
